 ...
 */
final class Version20191128132311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE status (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, value INTEGER DEFAULT NULL)');
        $this->addSql('ALTER TABLE cart ADD COLUMN status_id INTEGER DEFAULT NULL');
